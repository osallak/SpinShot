...
const Conversation = (props: socket) => {
...
//   useEffect(() => socketInitializer(), []);
  return (
    <div className="bg-white/10 md:h-full h-[90%] rounded-2xl w-full flex justify-between items-center flex-col">
              ...
              >
                <div
                  className={`bg-transparent x-pp:w-[700px] 2xl:w-[600px] xl:w-[500px] lg:w-[70%] w-[80%] flex ${
                    "receiver" != "receiver" ? "items-start" : "items-end"
