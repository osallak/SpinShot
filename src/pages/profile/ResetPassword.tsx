...
const ResetPassword = () => {
  return (
    <div className=" space-y-16 md:space-y-36 h-full">
      <div className=" text-pearl text-[15px] sm:text-2xl sm:text-2x h-[14%] md:h-[18%] c-gb:h-[25%] flex items-center c-10xl:px-24 px-16">
      ...
      <div className=" text-pearl h-[18%] c-gb:h-[25%] space-y-10 justify-center flex c-10xl:px-24 px-16 flex-col">
        {resetPassword.map((option, index) => (
          <div key={index} className=" flex flex-row justify-center">
            ...
            <div className="   bg-very-dark-purple w-[500px] rounded-[20px]">
              <input
                className=" bg-very-dark-purple w-full rounded-[20px] px-7 h-14 opacity-40"
                type="text"
