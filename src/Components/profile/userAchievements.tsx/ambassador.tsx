...
const Ambassador = () => {
  ...
  return (
    <div className=" bg-very-dark-purple h-[150px] sm:h-[200px] c-gb:h-[300px]  rounded-[20px] w-[85%] c-gb:w-full flex flex-row  justify-between">
      <div className={` ${achievement_data?.profile?.achievements[3]?.achieved ? "text-pearl " : "text-pearl opacity-40"} p-4 sm:p-10 space-y-[20%]`}>
      ...
      <div className="flex justify-center items-center  md:w-[40%]  ">
        {achievement_data?.profile?.achievements[3]?.achieved ? (
          <Image
