...
/* */
    ...
    const patchProfile = async (data:any) => {
        ...
        try{
          const response = await axios.patch('http://e3r10p16.1337.ma:3001/api/v1/users/settings', data, {
          headers: {
                ...
                <div className="flex flex-col  text-pearl  w-full c-10xl:w-[80%] space-y-5 md:space-y-14  c-10xl:px-20 px-6 ">
                    <div className="   c-10xl:space-x-[15%] w-full  ">
                            <div className=" flex flex-col space-y-5 md:space-y-0 md:flex-row md:space-x-5 w-full c-10xl:w-full">
                                <input name="First_name" className="bg-very-dark-purple w-full c-10xl:w-full  rounded-[20px] px-5 h-14 placeholder:text-pearl placeholder:text-opacity-40" onChange={handleChange} type="" required placeholder="First name" />
                                <input name="Last_name" className="bg-very-dark-purple w-full c-10xl:w-full  rounded-[20px] px-5 h-14 placeholder:text-pearl placeholder:text-opacity-40" onChange={handleChange} type="" required placeholder="Last name"/>
                            </div>
                    </div>
                    <div className="flex flex-col space-y-10 md:space-y-0 md:flex-row  c-10xl:space-x-[10%] items-center">
                        <div className=" w-full">
                            <input name="Username" className="bg-very-dark-purple w-[100%] md:w-[49%]  rounded-[20px] px-5 h-14 placeholder:text-pearl placeholder:text-opacity-40" onChange={handleChange} type="" required placeholder="Username"/>
                        </div>
                    </div>
                    <div className="flex flex-col space-y-8 md:space-y-0 md:flex-row   c-10xl:space-x-[15%] items-center">
                        <div className=" w-full">
                            <input name="Email" className="bg-very-dark-purple w-full  rounded-[20px] px-5 h-14 placeholder:text-pearl placeholder:text-opacity-40" onChange={handleChange} type="" required placeholder="Email"/>
                        </div>
                    </div>
                    <div className="flex flex-col space-y-10 md:space-y-0 md:flex-row  c-10xl:space-x-[10%] items-center">
