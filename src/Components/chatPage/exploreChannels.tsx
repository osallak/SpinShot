      ...
      <Dialog as="div" className="relative z-10" onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center text-center bg-black bg-opacity-70">
            ...
            >
              <Dialog.Panel className="transform overflow-hidden rounded-2xl bg-pearl lg:p-6 p-1 shadow-xl transition-all lg:w-[900px] md:w-[700px] sm:w-[90%] w-[80%] flex justify-center items-center">
                <div className="w-full xl:h-[900px] md:h-[800px] sm:h-[600px] h-[400px] md:space-y-5 sm:space-y-3 space-y-0">
                  <div
                    className="text-lg font-medium leading-6 text-gray-900 flex justify-center items-center flex-col md:h-[120px] sm:h-[100px] h-[80px]"
                  >
                    <Image
                          ...
                          <div className="flex flex-row h-full lg:space-x-2 space-x-1 w-[70%]">
                            ...
                            <div className="h-full lg:w-[200px] md:w-[170px] w-[140px] flex flex-col space-y-3">
                              <div className="h-[50%] flex flex-row justify-start items-end space-x-2">
                                <p className="font-Poppins lg:text-lg md:text-md text-[10px] text-pearl">
                                  {content.name}
                                </p>
                              </div>
